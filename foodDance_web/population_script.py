...
recipes = [
    {'title': 'Floral Yoghurt Biscuits',
     ...
     'steps': [
         ...
         {'image': 'recipes/floral-yoghurt-biscuits_1.jpg',
         ...
         {'image': 'recipes/floral-yoghurt-biscuits_2.jpg',
    ...
    {'title': 'Paella mixta',
     ...
     'steps': [
         ...
         {'image': 'recipes/paella-mixta_1.jpg',
         ...
         {'image': 'recipes/paella-mixta_2.jpg',
         ...
         {'image': 'recipes/paella-mixta_3.jpg',
    ...
    {'title': 'Vegan Cheesecake',
     ...
     'comments': [
         ...
         {'user': 'yuuki', 'rating': 2,
          'content': "This cake is absolutely perfect it's so soft and delicious wow just wow"},
    ...
    {'title': 'Beef curry',
     ...
     'steps': [
         ...
         {'image': 'recipes/beef-curry_1.jpg',
         ...
         {'image': 'recipes/beef-curry_2.jpg',
     ...
     'comments': [
         ...
         {'user': 'espoir', 'rating': 4,
          'content': "I've made this three times in the last couple of months. It's delicious and everyone ate it."},
    ...
    {'title': 'Roast chicken',
     ...
     'steps': [
         ...
         {'image': 'recipes/roast-chicken_1.jpg',
         ...
         {'image': 'recipes/roast-chicken_2.jpg',
         ...
         {'image': 'recipes/roast-chicken_3.jpg',
    ...
    {'title': 'Sponge pudding',
     ...
     'steps': [
         ...
         {'image': 'recipes/sponge-pudding_1.jpg',
    ...
    {'title': 'Sauteed Cauliflower with Mushrooms',
     ...
     'steps': [
         {'image': 'recipes/sauteed-cauliflower-with-mushrooms_1.jpg',
         ...
         {'image': 'recipes/sauteed-cauliflower-with-mushrooms_2.jpg',
         ...
         {'image': 'recipes/sauteed-cauliflower-with-mushrooms_3.jpg',
     ...
     'comments': [
         ...
         {'user': 'flechazo', 'rating': 5,
          'content': "I follow this recipe and cook for my parents last week, they said it's over imagine!"},
    ...
    {'title': 'Tortilla pizza',
     ...
     'steps': [
         ...
         {'image': 'recipes/tortilla-pizza_1.jpg',
          'content': 'Scatter with the mozzarella, add the pepperoni and jalapenos. '},
         {'image': 'recipes/tortilla-pizza_2.jpg',
    ...
    {'title': 'Beef stew',
     ...
     'comments': [
         {'user': 'flechazo', 'rating': 5,
          'content': "Absolutely delicious! So easy to make and everyone loves it."},
         {'user': 'Augenstern', 'rating': 1, 'content': "Too time consuming to make it second time"},
         {'user': 'espoir', 'rating': 5,
          'content': "It's my first time cooking beef and I followed this recipe. Too delicious to believe it's my own work!"},
     ]
     },
    ...
    {'title': 'Chocolate cake',
     ...
     'steps': [
         ...
         {'image': 'recipes/chocolate-cake_1.jpg',
    ...
    {'title': 'Poke Bowl',
     ...
     'comments': [
         {'user': 'diablo', 'rating': 4,
          'content': "It's really easy and yummy, I have already recommend this to all my friends."},
         {'user': 'flechazo', 'rating': 5,
          'content': "I have tries poke bowl before, but this pairing was so much better than the ones I've tried before and the sauce was really tasty."},
    ...
    {'title': 'Seafood pasta',
     ...
     'steps': [
         {'image': 'recipes/seafood-pasta_1.jpg',
         ...
         {'image': 'recipes/seafood-pasta_2.jpg',
     ...
     'comments': [
         ...
         {'user': 'flechazo', 'rating': 4,
          'content': "Can you add cream, or creme fraiche to make it a creamy sauce?"},
    ...
    {'title': 'Volcanic Lava Egg',
     ...
     'comments': [
         {'user': 'Augenstern', 'rating': 5,
          'content': "It's so yummy! I've tried many times, with great success, every time."},
         {'user': 'espoir', 'rating': 5,
          'content': "Love it! If you don't want to carve the potatoes you can just put the ingredients together."},
    ...
    {'title': 'Low Fat North African Egg',
     ...
     'steps': [
         ...
         {'image': 'recipes/low-fat-north-african-egg_3.jpg',
         ...
         {'image': 'recipes/low-fat-north-african-egg_4.jpg',
          'content': 'Finally, reduce the heat to medium, dig three holes in the tomatoes and simmer the eggs in.'},
         {'image': 'recipes/low-fat-north-african-egg_5.jpg',
          'content': 'Done!'},
     ],
     'comments': [
         {'user': 'flechazo', 'rating': 3,
          'content': "Love it but it takes too much time to prepare the materials."},
    ...
    {'title': 'Beef Donburi',
     ...
     'steps': [
         {'image': 'recipes/beef-donburi_1.jpg',
         ...
         {'image': 'recipes/beef-donburi_2.jpg',
         ...
         {'image': 'recipes/beef-donburi_3.jpg',
     ...
     'comments': [
         ...
         {'user': 'espoir', 'rating': 4,
          'content': "Very tasty, just hard to get the timing right for the omelette."},
    ...
    {'title': 'Steamed Buns',
     ...
     'steps': [
         ...
         {'image': 'recipes/steamed-buns_2.jpg',
          'content': 'recipes/Mix the shredded potatoes, shredded carrots, shredded green pepper, shredded ham, egg, salt and soy sauce.'},
     ...
     'comments': [
         ...
         {'user': 'Augenstern', 'rating': 5,
          'content': "I've fall in love with it, it's simple and also very decilious"},
     ]
     },
    ...
    {'title': 'Oatmeal and Avocado Tart',
     ...
     'steps': [
         ...
         {'image': 'recipes/oatmeal-and-avocado-tart_1.jpg',
         ...
         {'image': 'recipes/oatmeal-and-avocado-tart_2.jpg',
...
def populate(mode="prod"):
    mode_print(mode, test_message="Initialize the test data. Please Wait about 30 seconds")

    # mark how long the populate needs
    total_size = len(users) + len(recipes) + len(collections)
    current = 0.0
    ...
    for user in users:
        ...
        mode_print(mode, f'- User populate: {user} added')

        current += 1
        print("Populate remaining {:.2%}/100%".format(current / total_size))
    ...
    for collection in collections:
        for recipe in collection['recipes']:
            ...
            mode_print(mode, f"- Collection populate : {collection['user']} collect {recipe}")
...
def add_recipe(title, author_name, overview, duration, budget, difficulty, materials, steps, comments, image=None,
    ...
    mode_print(mode, f'-Recipe Populate: {r} added')

    if image:
        r.image = os.path.join(image)
        mode_print(mode, f'        - add image {image} to {r} (updated)')

    r.save()

    for material in materials:
        m = add_material(r, material['ingredient'], material['weight'])
        mode_print(mode, f'        Material Populate - add {m} into the materials of {r}')
    ...
    for step in steps:
        ...
        mode_print(mode, f'        Step Populate - add  {s} into the steps of {r}')

    for comment in comments:
        c = add_comment(comment['user'], r, comment['rating'], comment['content'])
        mode_print(mode, f'        Comment Populate - add  {c} into the comments of {r}')
...
def mode_print(mode, prod_message="", test_message=""):
    """
    Print the message if the mode is not a "test" mode
    """
    if mode == "test" and test_message != "":
        print(test_message)
    elif mode == "prod" and prod_message != "":
        print(prod_message)
